...
public class L3Climb extends SubsystemBase {
    ...
    private final DigitalInput limitSwitchHook = new DigitalInput(4);
    private final DigitalInput limitSwitchTop = new DigitalInput(5);
    private final DigitalInput limitSwitchBottom = new DigitalInput(6);
    ...
    public L3Climb() {
        ...
        climbMotor2Config.follow(climbMotor1);
        climbMotor2Config.inverted(true);
        climbMotor2Config.follow(slideMotor1);
        climbMotor2Config.inverted(true);
