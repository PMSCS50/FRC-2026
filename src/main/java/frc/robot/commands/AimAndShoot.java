...
public class AimAndShoot extends Command {
    ...
    @Override
    public void execute() {
        vx = xInput.getAsDouble() * MaxSpeed * speedLimiter;
        vy = yInput.getAsDouble() * MaxSpeed * speedLimiter;
        if (vision.hasTargets()) {
            ...
            if (targetOptional.isPresent()) {
                ...
                //3. get field speeds
                var fieldSpeeds = ChassisSpeeds.fromRobotRelativeSpeeds(drivetrain.getSpeeds(), robotYaw);
