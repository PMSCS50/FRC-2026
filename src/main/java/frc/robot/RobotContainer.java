...
public class RobotContainer {
    ...
    private final Shooter shooter = new Shooter(new ShooterIOSim());
    ...
    public RobotContainer() {
        ...
        NamedCommands.registerCommand("alignToTag", new PV_Align(drivetrain, vision, 18)); //vision.getBestTarget().getFiducialId())
        ...
        NamedCommands.registerCommand("alignToTag", new PV_Align(drivetrain, vision, 25)); // change 18 to your target tag
    ...
    private void configureBindings() {
        ...
        joystick.x().onTrue(new PV_Align(drivetrain, vision, 25));
        ...
        drivetrain.setDefaultCommand(
            drivetrain.applyRequest(() -> {
                ...
                if (joystick.a().getAsBoolean() && vision.hasTargets() && vision.getBestTarget().getFiducialId() == 18) {
                    double kp = 1.5;
